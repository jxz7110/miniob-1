...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_agg_type = 100,                 /* agg_type  */
  YYSYMBOL_attr_list = 101,                /* attr_list  */
  YYSYMBOL_agg_list = 102,                 /* agg_list  */
...
static const yytype_int16 yyrline[] =
{
     ...
     274,   280,   288,   314,   317,   329,   339,   358,   361,   374,
     382,   392,   395,   396,   397,   398,   401,   417,   420,   431,
     435,   439,   447,   459,   474,   521,   531,   536,   547,   550,
     553,   556,   559,   563,   566,   574,   581,   590,   602,   607,
     616,   622,   627,   634,   638,   642,   646,   650,   657,   660,
     673,   676,   689,   692,   756,   759,   765,   768,   774,   777,
     782,   789,   801,   813,   825,   840,   841,   842,   843,   844,
     845,   846,   847,   851,   852,   853,   854,   855,   858,   871,
     879,   889,   890
};
#endif
...
static const char *const yytname[] =
{
  ...
  "FLOAT_T", "DATE_T", "MAX", "MIN", "COUNT", "AVG", "SUM", "HELP", "EXIT",
  "DOT", "INTO", "VALUES", "FROM", "WHERE", "AND", "SET", "INNER", "LEFT",
  "RIGHT", "FULL", "JOIN", "ON", "LOAD", "DATA", "INFILE", "EXPLAIN", "EQ",
  "LT", "GT", "LE", "GE", "NE", "LIKE", "NOT", "NUMBER", "FLOAT", "ID",
  ...
  "select_attr", "rel_attr", "agg_attr", "agg_type", "attr_list",
  "agg_list", "rel_list", "on", "where", "condition_list", "condition",
  "comp_op", "join_op", "load_data_stmt", "explain_stmt",
...
{
      81,     7,    22,    -7,   -22,   -59,    10,  -158,     2,   -17,
     -23,  -158,  -158,  -158,  -158,  -158,   -21,    -3,    81,    27,
      38,  -158,  -158,  -158,  -158,  -158,  -158,  -158,  -158,  -158,
    -158,  -158,  -158,  -158,  -158,  -158,  -158,  -158,  -158,  -158,
    -158,    18,    19,    21,    26,    -7,  -158,  -158,  -158,    -7,
    -158,  -158,    -5,  -158,  -158,  -158,  -158,  -158,    12,  -158,
      17,    37,    52,    71,  -158,  -158,    28,    51,    58,    48,
      70,  -158,  -158,  -158,  -158,    83,    74,  -158,    76,   -15,
    -158,    -7,    -7,    -7,    -7,    -7,    62,    63,    64,  -158,
      39,  -158,   -43,    90,    89,    68,   -36,    72,    69,    75,
      77,  -158,  -158,   -34,   -34,  -158,  -158,  -158,    -8,    37,
      52,  -158,   114,   115,   117,   120,    16,  -158,    88,  -158,
     105,    92,   122,   125,  -158,  -158,    98,    99,   100,   101,
      89,    86,  -158,  -158,  -158,  -158,  -158,   -36,    53,    53,
    -158,   109,   -36,   143,  -158,  -158,  -158,  -158,   133,    69,
     134,    93,  -158,  -158,  -158,  -158,  -158,   107,   132,  -158,
    -158,  -158,  -158,  -158,  -158,  -158,   102,    16,    16,    16,
      89,    94,    97,   122,  -158,   138,    16,    -8,   -36,   140,
    -158,  -158,  -158,  -158,  -158,  -158,  -158,  -158,   142,  -158,
     104,   144,  -158,  -158,   132,  -158,  -158,   138,  -158,  -158,
    -158
};
...
static const yytype_int8 yydefact[] =
{
     ...
     111,    22,    21,    14,    15,    16,    17,     9,    10,    11,
      ...
      64,    55,    56,    73,    74,    75,    76,    77,    68,    65,
       0,    78,    80,     0,    31,    30,     0,     0,     0,     0,
       0,   109,     1,   112,     2,     0,     0,    29,     0,     0,
      63,     0,     0,     0,     0,     0,     0,     0,     0,    66,
       0,    67,     0,     0,    86,     0,     0,     0,     0,     0,
       0,    62,    57,    58,    59,    60,    61,    69,    82,    78,
      80,    41,     0,     0,     0,     0,    88,    52,     0,   110,
       0,     0,    37,     0,    35,   107,     0,     0,     0,     0,
      86,     0,    79,    81,    70,    71,    72,     0,     0,     0,
      87,    89,     0,     0,    42,    43,    44,    45,    40,     0,
       0,     0,   103,   104,   105,   106,    54,    84,    47,    95,
      96,    97,    98,    99,   100,   101,     0,     0,     0,    88,
      86,     0,     0,    37,    36,    33,    88,    82,     0,     0,
     102,    92,    94,    91,    93,    90,    53,   108,     0,    38,
       0,     0,    85,    83,    47,    46,    39,    33,    32,    48,
      34
};
...
{
    -158,  -158,   148,  -158,  -158,  -158,  -158,  -158,  -158,  -158,
    -158,  -158,  -158,   -30,  -158,  -158,   -12,    20,    -2,  -158,
    -158,   -26,   -95,  -158,  -158,  -158,  -158,    91,   -20,  -158,
      -4,    84,  -158,    66,    61,    -1,  -158,  -126,  -157,  -158,
      34,  -158,  -158,  -158,  -158,  -158
};
...
static const yytype_uint8 yydefgoto[] =
{
      ...
      28,    29,    30,   191,    31,    32,   150,   122,   114,   148,
      33,   179,    50,    34,    35,    36,    37,    51,    52,    60,
     139,    62,    63,    89,    91,   130,   177,   117,   140,   141,
     167,   131,    38,    39,    40,    74
};
...
{
      61,   119,    64,   101,   156,    53,    54,    55,    56,    57,
      45,   125,   185,    41,    81,    42,   111,    65,   112,   192,
      67,   138,   113,    46,    47,    79,    48,    72,    43,    80,
      44,    84,    85,   126,   127,   128,   129,    66,    68,    58,
      69,    73,   158,    59,   186,    70,    86,   170,    82,    83,
      84,    85,    46,    47,    87,    48,    88,    49,    82,    83,
      84,    85,   103,   104,   105,   106,    53,    54,    55,    56,
      57,    90,   181,   183,   138,    46,    47,    58,    48,    75,
      76,   138,    77,   194,   109,     1,     2,    78,    92,    93,
       3,     4,     5,     6,     7,     8,     9,    10,    95,    96,
      98,    11,    12,    13,   159,   160,   161,   162,   163,   164,
     165,   166,    94,    14,    15,   144,   145,   146,   147,    97,
      99,    16,   100,   107,   108,    58,   115,   116,    17,   118,
     121,    18,   134,   135,   120,   136,   123,   137,   124,   142,
     143,   149,   151,   152,   153,   154,   155,   157,   169,   171,
     172,   178,   174,   176,   175,   187,   111,   190,   195,   180,
     196,   189,   198,   182,   184,   197,    71,   200,   199,   173,
     188,   133,   102,   168,   110,   132,   193
};

static const yytype_uint8 yycheck[] =
{
       4,    96,    61,    18,   130,    27,    28,    29,    30,    31,
      17,    19,   169,     6,    19,     8,    59,     7,    61,   176,
      37,   116,    65,    59,    60,    45,    62,     0,     6,    49,
       8,    65,    66,    41,    42,    43,    44,    35,    61,    61,
      61,     3,   137,    65,   170,    48,    34,   142,    63,    64,
      65,    66,    59,    60,    37,    62,    19,    64,    63,    64,
      65,    66,    82,    83,    84,    85,    27,    28,    29,    30,
      31,    19,   167,   168,   169,    59,    60,    61,    62,    61,
      61,   176,    61,   178,    88,     4,     5,    61,    17,    61,
       9,    10,    11,    12,    13,    14,    15,    16,    40,    51,
      17,    20,    21,    22,    51,    52,    53,    54,    55,    56,
      57,    58,    61,    32,    33,    23,    24,    25,    26,    49,
      46,    40,    46,    61,    61,    61,    36,    38,    47,    61,
      61,    50,    18,    18,    62,    18,    61,    17,    61,    51,
      35,    19,    17,    45,    45,    45,    45,    61,    39,     6,
      17,    19,    18,    46,    61,    61,    59,    19,    18,    57,
      18,   173,    18,   167,   168,    61,    18,   197,   194,   149,
     172,   110,    81,   139,    90,   109,   177
};
...
static const yytype_int8 yystos[] =
{
      ...
      16,    20,    21,    22,    32,    33,    40,    47,    50,    69,
      70,    71,    72,    73,    74,    75,    76,    77,    78,    79,
      80,    82,    83,    88,    91,    92,    93,    94,   110,   111,
     112,     6,     8,     6,     8,    17,    59,    60,    62,    64,
      90,    95,    96,    27,    28,    29,    30,    31,    61,    65,
      97,    98,    99,   100,    61,     7,    35,    37,    61,    61,
      48,    70,     0,     3,   113,    61,    61,    61,    61,    96,
      96,    19,    63,    64,    65,    66,    34,    37,    19,   101,
      19,   102,    17,    61,    61,    40,    51,    49,    17,    46,
      46,    18,    95,    96,    96,    96,    96,    61,    61,    98,
      99,    59,    61,    65,    86,    36,    38,   105,    61,    90,
      62,    61,    85,    61,    61,    19,    41,    42,    43,    44,
     103,   109,   101,   102,    18,    18,    18,    17,    90,    98,
     106,   107,    51,    35,    23,    24,    25,    26,    87,    19,
      84,    17,    45,    45,    45,    45,   105,    61,    90,    51,
      52,    53,    54,    55,    56,    57,    58,   108,   108,    39,
      90,     6,    17,    85,    18,    61,    46,   104,    19,    89,
      57,    90,    98,    90,    98,   106,   105,    61,    86,    84,
      19,    81,   106,   103,    90,    18,    18,    61,    18,    89,
      81
};
...
#line 1840 "yacc_sql.cpp"
  ...
  case 32: /* create_index_stmt: CREATE INDEX ID ON ID LBRACE ID index_list RBRACE  */
#line 289 "yacc_sql.y"
    {
        (yyval.sql_node) = new ParsedSqlNode(SCF_CREATE_INDEX);
        if((yyvsp[-6].string) != nullptr){
          (yyval.sql_node)->create_index.index_name = (yyvsp[-6].string);
          free((yyvsp[-6].string));
        }
        if((yyvsp[-4].string) != nullptr){
          (yyval.sql_node)->create_index.relation_name = (yyvsp[-4].string);
          free((yyvsp[-4].string));
        }
        if((yyvsp[-1].indexion_list) != nullptr){
          (yyval.sql_node)->create_index.attribute_names.swap(*(yyvsp[-1].indexion_list));
          delete (yyvsp[-1].indexion_list);
        }
        if((yyvsp[-2].string) != nullptr){
          (yyval.sql_node)->create_index.attribute_names.push_back((yyvsp[-2].string));

        }
        std::reverse((yyval.sql_node)->create_index.attribute_names.begin(),(yyval.sql_node)->create_index.attribute_names.end());
        free((yyvsp[-2].string));
...
#line 1867 "yacc_sql.cpp"
  ...
  case 33: /* index_list: %empty  */
#line 314 "yacc_sql.y"
    {
      (yyval.indexion_list) = nullptr;
    }
#line 1875 "yacc_sql.cpp"
    break;

  case 34: /* index_list: COMMA ID index_list  */
#line 317 "yacc_sql.y"
                          {
        if((yyvsp[0].indexion_list) !=nullptr){
            (yyval.indexion_list) = (yyvsp[0].indexion_list);
        } else {
            (yyval.indexion_list)= new std::vector<std::string>;
        }
        (yyval.indexion_list)->push_back((yyvsp[-1].string));
        free((yyvsp[-1].string));
    }
...
#line 475 "yacc_sql.y"
    {
      ...
      if ((yyvsp[-1].select_sql_node) != nullptr) {
        SelectSqlNode * select_node = (yyvsp[-1].select_sql_node);
        // 寻找最左叶子节点
        while (true) {
        ...
        table_node->relations.push_back((yyvsp[-2].string));
        ...
        std::swap((yyval.sql_node)->selection, *(yyvsp[-1].select_sql_node));
        delete (yyvsp[-1].select_sql_node);
      } else {
        // 直接初始化真实表
        (yyval.sql_node)->selection.table_type = SPECIFIC_REL;
      ...
      if ((yyvsp[0].condition_list) != nullptr) {
        for (ConditionSqlNode node : *(yyvsp[0].condition_list)) {
...
#line 2261 "yacc_sql.cpp"
  ...
  case 67: /* select_attr: agg_attr agg_list  */
#line 590 "yacc_sql.y"
                        {
      if ((yyvsp[0].rel_attr_list) != nullptr) {
        (yyval.rel_attr_list) = (yyvsp[0].rel_attr_list);
      ...
      (yyval.rel_attr_list)->emplace_back(*(yyvsp[-1].agg_attr));
      delete (yyvsp[-1].agg_attr);
    }
...
#line 2297 "yacc_sql.cpp"
  ...
  case 70: /* agg_attr: agg_type LBRACE ID RBRACE  */
#line 616 "yacc_sql.y"
                              {
      (yyval.agg_attr) = new RelAttrSqlNode;
      (yyval.agg_attr)->attribute_name = (yyvsp[-1].string);
      (yyval.agg_attr)->aggregation_type = (yyvsp[-3].string);
      free((yyvsp[-1].string));
    }
#line 2308 "yacc_sql.cpp"
    break;

  case 71: /* agg_attr: agg_type LBRACE '*' RBRACE  */
#line 622 "yacc_sql.y"
                               {
      (yyval.agg_attr) = new RelAttrSqlNode;
      (yyval.agg_attr)->attribute_name = '*';
      (yyval.agg_attr)->aggregation_type = (yyvsp[-3].string);
    }
#line 2318 "yacc_sql.cpp"
    break;

  case 72: /* agg_attr: agg_type LBRACE number RBRACE  */
#line 627 "yacc_sql.y"
                                  {
      (yyval.agg_attr) = new RelAttrSqlNode;
      (yyval.agg_attr)->attribute_name = '1';
      (yyval.agg_attr)->aggregation_type = (yyvsp[-3].string);
    }
#line 2328 "yacc_sql.cpp"
    break;

  case 73: /* agg_type: MAX  */
#line 634 "yacc_sql.y"
       {
      char str[]="max";
      (yyval.string)=str;
...
#line 2403 "yacc_sql.cpp"
  ...
  case 81: /* agg_list: COMMA agg_attr agg_list  */
#line 676 "yacc_sql.y"
                              {
      if((yyvsp[0].rel_attr_list) !=nullptr){
        (yyval.rel_attr_list) = (yyvsp[0].rel_attr_list);
...
#line 689 "yacc_sql.y"
    {
      (yyval.select_sql_node) = nullptr;
    }
#line 2425 "yacc_sql.cpp"
    break;

  case 83: /* rel_list: join_op ID on rel_list  */
#line 692 "yacc_sql.y"
                             {
      if ((yyvsp[0].select_sql_node) != nullptr) {
        (yyval.select_sql_node) = (yyvsp[0].select_sql_node);
        SelectSqlNode * select_node = (yyval.select_sql_node);
        // 寻找最左叶子节点
        while (true) {
          if (select_node->table_type == JOIN_REL && select_node->selections.size() == 2) {
            select_node = select_node->selections[0];
        ...
        join_node->join_op = (yyvsp[-3].join_op);
        ...
        // join表即返回值
        (yyval.select_sql_node) = join_node;
...
#line 2662 "yacc_sql.cpp"
  ...
  case 103: /* join_op: INNER JOIN  */
#line 851 "yacc_sql.y"
                  { (yyval.join_op) = INNER_JOIN; }
#line 2668 "yacc_sql.cpp"
    break;

  case 104: /* join_op: LEFT JOIN  */
#line 852 "yacc_sql.y"
                  { (yyval.join_op) = LEFT_JOIN; }
#line 2674 "yacc_sql.cpp"
    break;

  case 105: /* join_op: RIGHT JOIN  */
#line 853 "yacc_sql.y"
                  { (yyval.join_op) = RIGHT_JOIN; }
#line 2680 "yacc_sql.cpp"
    break;

  case 106: /* join_op: FULL JOIN  */
#line 854 "yacc_sql.y"
                  { (yyval.join_op) = FULL_JOIN; }
#line 2686 "yacc_sql.cpp"
    break;

  case 107: /* join_op: COMMA  */
#line 855 "yacc_sql.y"
                  { (yyval.join_op) = CARTESIAN; }
